...
oldRouter.get("/status", function (req, res) {
  res.send("Finance API is up")
});

oldRouter.get("/api/contract/:contractNumber", function (req, res) {
  knex.select(
...
oldRouter.get("/api/gl/v2/contracts", function (req, res) {
...
oldRouter.get("/api/gl/v2/:account", function (req, res) {
...
oldRouter.get("/api/gl/v2/contract/:contractNumber", function (req, res) {
  var query = knex.select(
...
oldRouter.get("/api/gl/:account/:contractNumber", function (req, res) {
  knex.select(
...
oldRouter.get("/cs/accounts/:accountNumber", function (req, res) {
  knex.select(
...
oldRouter.get("/cs/accounts", function (req, res) {
  knex.select(
    'Account as account', 'deptDescr as department', 'AcctDescr as accountDescription', 'TypeDescr as type',
    'ActiveDescr as status', 'ObjectDescr as objectDescription', 'A2VoteDescr as voteDescription',
    'A2ProgDescr as programDescription', 'A2ActivityDescr as activityDescription', 'A2ElementDescr as elementDescription'
...
oldRouter.post("/vendor/search", async (req, res) => {
  let { term } = req.body;
...
oldRouter.post("/transactions/search", [
